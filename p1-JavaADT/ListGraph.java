...
public class ListGraph implements Graph {
        ...
        public boolean hasEdge(String n1, String n2) {
                ...
                if (graphContainN1 && graphContainN2)
                {
                        ...
                        //the two nodes
                        result = (this.nodes.get(n1).contains(n2)) ?
                                true : false;
                }
                else
                {
        ...
        public List<String> succ(String n)
        {
                ...
                List<String> nodesWithEdgeFromGivenNode = new 
                        ArrayList<String>();
        ...
        public List<String> pred(String n) {
                ...
                List<String> nodesWithEdgeToGivenNode = new
                        ArrayList<String>();
        ...
        public Graph union(Graph g)
        {
                ...
                for (String currentNode : combinedNodes)
                {
                        for (String edgeNode : combinedNodes)
                        {
                                ...
                                {
                                        if (this.hasEdge(currentNode, edgeNode)
                                                || g.hasEdge(currentNode,
                                                edgeNode))
                                        {
                                                newGraph.addEdge(currentNode,
                                                edgeNode); //SD TODO: Might want to come back and check
                                        }
                                }
                        }
                }
                    ...
                    subGraph = new ListGraph();
                        ...
                        for (String currentNode : nodes)
                        {
                                ...
                                if (this.hasNode(currentNode) &&
                                        ...
                                        List<String> currNodeEdges =
                                                this.succ(currentNode);
